...
Good day <strong>Ma'am/Sir</strong>,
    <div class="container" style=" text-indent: 50px;">
        ...
        Attached here with is the  <span  style="background-color:#effc03;font-size:20px;  font-weight: bold;"> "{{$group =="Deposit" ? 'Statement of Account' : 'for Replenishment Report'}}" </span> for the event held on <strong>{{$date}} </strong>
